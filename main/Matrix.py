...
class Cell(TextComponent):
    ...
    def setColor(self, color):
        self.color = color
        self.text_color = invertColor(self.color)
        self.text = self.font.render(self.text_string,1,self.text_color)
...
class SquareCellMatrix():
    ...
    '''
    CELL_RATIO = 12
    def __init__(self, N, cell_size, screen_width, screen_height, colorMode="gradient"):
        self.N = N
        ...
        self.colorgenerator = ColorGenerator(colorMode)
    ...
    def setColorMode(self, colorMode):
        ...
        for row in self.matrix:
            for cell in row:
                cell.setColor(self.colorgenerator.getNextColor())
